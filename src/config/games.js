...
export const ALL_GAMES = {
  ...
  'most-likely': {
    ...
    name: 'Most Likely To',
    emoji: '🏆',
    description: 'Vote on who fits the prompt best!',
    color: 'var(--warning)',
    category: 'party',
    status: 'experimental',
    premium: false,
    features: ['multiplayer', 'voting'],
    minPlayers: 2,
    maxPlayers: 8,
  },
  'bluff-battle': {
    ...
    name: 'Bluff Battle',
    emoji: '🃏',
    description: 'Write fake answers. Fool your friends!',
    color: 'var(--danger)',
    category: 'party',
    status: 'experimental',
    premium: true,
    features: ['multiplayer', 'deception'],
    minPlayers: 2,
    maxPlayers: 8,
  },
  'sound-off': {
  ...
  'caption-this': {
    ...
    status: 'experimental',
    premium: true,
    features: ['multiplayer', 'creative', 'voting'],
    minPlayers: 2,
    maxPlayers: 8,
  },
  'word-association': {
    ...
    emoji: '💭',
    description: 'Quick-fire word matching. Think alike!',
    color: 'var(--accent)',
    category: 'party',
    status: 'experimental',
    premium: true,
    features: ['multiplayer', 'quick', 'sync'],
    minPlayers: 2,
    maxPlayers: 8,
  },
  'ranked-choice': {
    ...
    name: 'Ranked Choice',
    emoji: '🏆',
    description: 'Rank options and match the group!',
    color: 'var(--warning)',
    category: 'party',
    status: 'experimental',
    premium: true,
    features: ['multiplayer', 'social', 'opinion'],
    minPlayers: 2,
    maxPlayers: 8,
  },
  'photo-race': {
